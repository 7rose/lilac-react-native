...
export default class CZImagePlaceholder extends Component{
    ...
    constructor(props) {
        super(props);
        this.state = {
            url: !_.isEmpty(this.props.url) ? this.props.url : 'https://11.com/1.png'
        }
        //下载状态值
    ...
    * */
    ...
    render() {
        ...
        //默认图
        let defaultSource = this.props.defaultSource ? this.props.defaultSource : home.placeholderImage;
        //图片样式
            ...
            if (width != 0 && height != 0) {
                contentView = (
                    <View>
                        ...
                        {
                            shwoDefaultImage ? (
                                <Image source={defaultSource} style={[{width: width, height: height, zIndex: 2,resizeMode:'center'}, styles.AbsoluteImage, style]}/>
                            ) : null
                        }
                        {/*{*/}
                        {/*    showLoading ? (*/}
