...
class LoadingSpinnerOverlay extends Component {
        ...
        <View
          style={[
            styles.overlay,
            {
              ...
              width: SCREEN_W,
              height: SCREEN_H - this.props.marginTop
            },
  ...
  show(
    ...
    this._loadingSpinnerShowAnimation &&
      this._loadingSpinnerShowAnimation.stop();
    this._loadingSpinnerHideAnimation &&
      this._loadingSpinnerHideAnimation.stop();
    this._loadingSpinnerAnimationToggle &&
    ...
    this._loadingSpinnerShowAnimation = Animated.timing(this.state.opacity, {
      toValue: 1,
      duration,
      easing,
      delay
  ...
  hide(
    ...
    this._loadingSpinnerHideAnimation = Animated.timing(this.state.opacity, {
      toValue: 0,
      duration,
      easing,
      delay
  ...
  _setLoadingSpinnerOverlayPosition(
    { modal, marginTop } = {
      modal: this.state.modal,
      marginTop: this.state.marginTop
    }
    ...
    let left = (SCREEN_W - this._loadingSpinnerWidth) / 2;
    let top =
      (SCREEN_H - this._loadingSpinnerHeight) / 2 -
      (modal && marginTop === 0 ? 0 : marginTop);
  ...
  _renderActivityIndicator() {
    return (
      <ActivityIndicator
        ...
        animating={true}
        color={RegularColorCode.PullDownRefresh.progress[0]}
        size={"large"}
      />
    );
  }
